...
_S is a simple, super fast, and content-first blog theme

== Description ==

_S is simple, super fast, and content-first blog theme
...
_S is distributed under the terms of the GNU GPL version 2.0

_S bundles the following third-party resources:
